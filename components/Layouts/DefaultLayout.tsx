    ...
    return (
        <App>
            ...
            <div>
                ...
                <div className="flex min-h-screen flex-col bg-white bg-gradient-to-r from-[#FCF1F4] to-[#EDFBF9] font-plusJakartasans text-base font-normal text-gray antialiased dark:bg-[#1A1A1A] dark:from-transparent dark:to-transparent">
