                ...
                <div className="container relative z-[1]">
                    <div className="text-center lg:w-1/2 ltr:lg:text-left rtl:lg:text-right">
                        ...
                        <p className="pb-10 text-lg font-semibold leading-[30px]">
                            At Rama Group, we blend innovation, strategy, and technology to deliver powerful business solutions across Bahrain and the Middle East.
                            With a team of passionate experts and four specialized divisions, we’re here to spark transformation, drive growth, and help you lead with confidence.
                            Whether it’s media, marketing, design, or tech—our integrated approach ensures your business stays ahead in a fast-changing world.
                        </p>
            ...
            <section className="relative py-14 lg:py-[100px] xl:-mt-[100px]">
                ...
                <div className="container relative z-[2] ltr:xl:pr-40 rtl:xl:pl-40">
                    <div className="lg:w-2/3">
                        ...
                        At Rama Group, our process is built to inspire, create, and deliver results — combining creative thinking, smart strategy, and powerful technology at every stage.
                        </p>
                    </div>
