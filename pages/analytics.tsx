...
const RamaAnalytics = () => {
    ...
    return (
        <div>
            <Head>
                <title>Analytics | Rama Group – Empowering Your Business Growth in Middle East</title>
            </Head>
            <div className="overflow-x-hidden">
                        ...
                        <div className="relative lg:flex lg:flex-row">
                            <div className="pt-14 pb-8 text-center text-white lg:w-3/5 lg:py-20 ltr:lg:text-left rtl:lg:text-right">
                                ...
                                <p className="my-8 text-lg lg:w-3/4">
                                    Rama Analytics helps you turn raw data into powerful, real-time visual insights — so you can make smarter, faster decisions.
                                </p>
                                <Link href="https://analytics.ramagroupbh.com/" className="btn mx-auto mt-2 block w-fit bg-white lg:mx-0 lg:rtl:ml-auto">
                                    Get Started
                                </Link>
                            </div>
                            <div
                            ...
                            >
                                <img src="/assets/images/analytics/banner-img.png" alt="" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-14 dark:bg-gray-dark lg:py-[100px]">
                    <h3 className="mb-10 text-center text-2xl font-bold text-black dark:text-white lg:mb-14">
                        Designed for the <span className="text-secondary">future</span> of data-driven teams.
                    </h3>
                    <LogoSlider />
                </section>
                    ...
                    <div className="w-full xl:px-[144px] px-6">
                        <div className="lg:w-1/2">
                            <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                                ...
                                <h4>Built to Power Smarter Decisions</h4>
                                <p className="mt-4 text-lg font-semibold">
                                    Rama Analytics is packed with the tools you need to turn raw data into real results. From tracking behavior to automating
                                    insights, every feature is designed to help you analyze faster, visualize better, and act smarter.
                                </p>
                            </div>
                        </div>
                        <div className="mt-16 grid gap-x-7 gap-y-12 text-lg font-semibold sm:grid-cols-2 lg:grid-cols-3 lg:gap-y-20">
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="line-clamp-8">
                                        Monitor key metrics and performance in real time. With live dashboards and instant data updates, you always have the
                                        latest insights to drive fast, informed decisions.
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    <h3 className="mb-6 text-[22px] font-extrabold text-black dark:text-white">User Journey Tracking</h3>
                                    <p className="line-clamp-8">
                                        Visualize every step your users take. Understand their behavior, identify friction points, and optimize experiences to
                            ...
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="line-clamp-8">
                                        Save hours with fully automated, scheduled reporting. Send custom reports to your team or stakeholders without lifting a
                                        finger — always on time, always up to date.
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="line-clamp-8">
                                        Identify drop-off points, bottlenecks, and conversion blockers across your sales or product funnel. Use data-backed
                                        insights to improve efficiency and drive growth.
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="line-clamp-8">
                                        Measure and compare different versions of your content, campaigns, or UX with ease. Gain confidence in your decisions by
                                        seeing what truly works — backed by data.
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="line-clamp-8 text-lg font-semibold">
                                        Connect with your favorite tools, databases, and platforms — from CRMs and ERPs to data lakes and cloud services. Rama
                                        Analytics plays well with the tools you already use.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative mx-auto max-w-[1540px] rounded-[32px] bg-black pt-14">
                        ...
                        <div className="container">
                            <div className="relative">
                                <img src="/assets/images/analytics/perfomance-doller-icon.svg" alt="" className="absolute bottom-0 ltr:left-0 rtl:right-0" />
                                <div className="grid gap-4 lg:grid-cols-2">
                                    <div className="pt-28 lg:pb-10 lg:pt-0">
                                        <div className="heading mb-12 ltr:lg:text-left rtl:lg:text-right">
                                            <h6 className="!text-secondary">Smarter Data. Stronger Decisions.</h6>
                                            <h4 className="pb-4 leading-normal !text-white lg:!leading-[50px]">Unlock Your Growth Potential</h4>
                                            <p className="text-lg font-semibold xl:w-11/12">
                                                Increase performance, streamline workflows, and deliver meaningful insights.
                                            </p>
                                        </div>
                                        <ul className="space-y-8 text-lg font-semibold text-white">
                                            <li className="flex items-center gap-3.5">
                                                ...
                                                <p>Fuel product growth with real-time insights.</p>
                                            </li>
                                            <li className="flex items-center gap-3.5">
                                                ...
                                                <p>Bring clarity and structure to your process.</p>
                                            </li>
                                            <li className="flex items-center gap-3.5">
                                                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-primary">
                                                    <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <p>Find trends and gaps with powerful analytics.</p>
                                            </li>
                                            <li className="flex items-center gap-3.5">
                                                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-secondary">
                                                    <svg width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <p>Future-ready features, including embedded analytics.</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="pb-20 lg:pt-20 lg:pb-8" data-aos="fade-up" data-aos-duration="1000">
                                        <img src="/assets/images/analytics/perfomance-img.png" alt="" className="w-full" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="w-full xl:px-[144px] px-6">
                        <div className="relative">
                            <div className="lg:w-2/3">
                                <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                                    <h6 className="!text-secondary">All Your Metrics in One Place</h6>
                                    <h4 className="">Easily Track All Activity and Understand Performance</h4>
                                    <p className="mt-4 text-lg font-semibold">
                                        No more guesswork — Rama Analytics helps you track how users interact with your platform, monitor performance in real
                                        time, and make smarter, data-driven decisions.
                                    </p>
                                </div>
                                <ul className="mt-14 space-y-14 lg:w-2/3">
                                    <li className="flex gap-5 sm:gap-8">
                                        <div className="flex h-12 w-12 flex-none items-center justify-center rounded-2xl bg-primary p-2 sm:h-[72px] sm:w-[72px]">
                                            <img src="/assets/images/analytics/tracking-icon.svg" alt="" />
                                        </div>
                                        <div className="flex-1">
                                            ...
                                            <p className="pt-4 text-lg font-semibold">
                                                Use powerful analytics and Reporting tools to monitor user behavior, trends, and conversions — all in one place.
                                            </p>
                                        </div>
                                    </li>
                                    <li className="flex gap-5 sm:gap-8">
                                        <div className="flex h-12 w-12 flex-none items-center justify-center rounded-2xl bg-secondary p-2 sm:h-[72px] sm:w-[72px]">
                                            <img src="assets/images/analytics/monitoring-icon.svg" alt="" />
                                        </div>
                                        <div className="flex-1">
                                            <h4 className="text-[22px] font-extrabold text-black dark:text-white">In-depth monitoring</h4>
                                            <p className="pt-4 text-lg font-semibold">
                                                Get detailed insights on sessions, usage patterns, and key metrics over time — so you know what’s working and
                                                where to improve.
                                            </p>
                                        </div>
                                    </li>
                            ...
                            <img
                                src="/assets/images/analytics/benifits-img.png"
                                alt=""
                ...
                <section className="py-14 lg:py-20">
                    <div className="w-full xl:px-[144px] px-6">
                        <div className="relative grid items-center gap-y-10 lg:grid-cols-2 lg:gap-4">
                            ...
                            />
                            <img
                                src="/assets/images/analytics/analysis-icon-dark.svg"
                                alt=""
                            ...
                            <div
                                ...
                                data-aos-duration="1000"
                            >
                                <img src="/assets/images/analytics/integration-img.png" alt="" />
                            </div>
                            <div className="heading mb-5 text-center ltr:lg:text-right rtl:lg:text-left">
                                <h6 className="!text-secondary">INTEGRATIONS</h6>
                                <h4 className="">Work With Data From Any Source — Your Way</h4>
                                <p className="mt-4 text-lg font-semibold">
                                    Rama Analytics helps you analyze data from social platforms, spreadsheets, and databases — all in one place. Simply collect
                                    or import your metrics, and we’ll help you turn them into clear, actionable insights.
                                </p>
                                <Link
                                    href="#"
                ...
                <section className="bg-white/50 py-14 dark:bg-white/[0.03] lg:py-20">
                    <div className="w-full xl:px-[144px] px-6">
                        ...
                        >
                            <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                                <h4 className="">Response & Sentiment Visibility</h4>
                                <p className="mt-6 text-lg font-semibold">
                                    Use data you’ve already collected to monitor how users are reacting to your content, campaigns, or product experience.
                                    Visual dashboards make trends, spikes, and shifts in sentiment easy to spot — no AI, just clarity.
                                </p>
                                <Link
                                    href="#"
                            ...
                            <div className="lg:ltr:pl-24 lg:rtl:pr-24">
                                <img src="/assets/images/analytics/optimization.png" alt="" className="rounded-2xl" />
                            </div>
                        </div>
                        <div
                        ...
                        >
                            <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                                <h4 className="">Move Your Data Forward — Seamlessly</h4>
                                <p className="mt-6 text-lg font-semibold">
                                    Modernize how you manage and view data by moving from outdated systems to flexible, cloud-ready tools. With Rama Analytics,
                                    it’s easy to import from spreadsheets, databases, or legacy tools — no technical barriers, just clean, ready-to-use
                                    insights.
                                </p>
                                <Link
                                    href="#"
                            ...
                            <div className="lg:ltr:pl-24 lg:rtl:pr-24">
                                <img src="/assets/images/analytics/migrate-modernize.png" alt="" className="rounded-2xl" />
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="w-full xl:px-[144px] px-6">
                        ...
                        <div className="grid gap-14 sm:grid-cols-2 lg:grid-cols-3">
                            <div data-aos="fade-up" data-aos-duration="1000">
                                <div className="mb-10">
                                    <img src="/assets/images/analytics/modern-design.svg" alt="" className="mx-auto w-24" />
                                </div>
                                ...
                                <p className="mt-6 mb-8 text-lg font-semibold line-clamp-4">
                                    Crafted with user experience at its core, our platform offers a sleek, intuitive interface that makes data easier to
                                    explore, analyze, and present — even for non-technical users.
                                </p>
                            ...
                            <div data-aos="fade-up" data-aos-duration="1000">
                                <div className="mb-10">
                                    <img src="/assets/images/analytics/magic-pagebuilder.svg" alt="" className="mx-auto w-24" />
                                </div>
                                <h4 className="text-[22px] font-extrabold text-black dark:text-white">Custom Dashboard Builder</h4>
                                <p className="mt-6 mb-8 text-lg font-semibold line-clamp-4">
                                    Easily build beautiful, flexible dashboards. Highlight the metrics that matter most, customize layouts, and share
                                    data-backed stories with your team — no code required.
                                </p>
                            ...
                            <div data-aos="fade-up" data-aos-duration="1000">
                                <div className="mb-10">
                                    <img src="/assets/images/analytics/support-icon.svg" alt="" className="mx-auto w-24" />
                                </div>
                                <h4 className="text-[22px] font-extrabold text-black dark:text-white">Support 24/7</h4>
                                <p className="mt-6 mb-8 text-lg font-semibold line-clamp-4">
                                    We're here whenever you need us. Our round-the-clock support ensures your team can stay focused on insights — not
                                    troubleshooting.
                                </p>
                                <Link href="/services-detail" className="text-lg font-extrabold text-secondary transition hover:text-primary">
                                    Read More +
