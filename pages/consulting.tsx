...
const Consulting = () => {
    ...
    return (
        <div>
            <Head>
                <title>Consulting | Rama Group – Empowering Your Business Growth in Middle East</title>
            </Head>
                            ...
                            {queries.map((faq: any, i: number) => {
                                return (
                                    <div key={faq.id} className="mt-5">
                                        <button
                                            type="button"
                                            className="relative flex w-full items-center justify-between gap-2 !bg-gray/30 px-5 py-2.5 !font-plusJakartasans text-lg font-bold text-black ltr:text-left rtl:text-right dark:!text-white sm:text-xl"
                                        ...
                                        <AnimateHeight duration={600} height={accordians === i ? 'auto' : 0}>
                                            <div className="bg-white p-5 font-plusJakartasans text-base font-medium text-gray dark:bg-white/5">
                                                <p>{faq.answer}</p>
                                            </div>
                                        </AnimateHeight>
                                    </div>
                        ...
                        <form action="" className="rounded-3xl bg-white px-4 py-12 dark:bg-[#2A2A2A] lg:w-2/3 lg:px-8">
                            <div className="grid gap-10 sm:grid-cols-2">
                                <div className="relative">
                                    ...
                                    />
                                    <label className="absolute -top-3 bg-white px-2 font-bold ltr:left-6 rtl:right-6 dark:bg-[#2A2A2A] dark:text-white">
                                        Full Name
                                    </label>
                                    <svg
                                        width="20"
