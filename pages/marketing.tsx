...
const Marketing = () => {
    ...
    return (
        <div className="overflow-x-hidden">
            <Head>
                <title>Marketing | Rama Group – Empowering Your Business Growth in Middle East</title>
            </Head>
                ...
                <div className="container">
                    ...
                    >
                        <div className="group relative rounded-3xl border-2 border-transparent bg-white p-6 shadow-[-20px_30px_70px_rgba(219,222,225,0.4)] transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none dark:hover:bg-secondary">
                            <Link
                                href="#"
                                className="absolute -top-[50px] flex h-[108px] w-[108px] items-center justify-center rounded-full bg-secondary text-white shadow-[0_15px_30px_rgba(225,137,137,0.4)] group-hover:bg-black group-hover:shadow-[0_15px_30px_rgba(225,137,137,0.4)] ltr:right-4 rtl:left-4"
                            >
